...
use Gantry::Samples::Model::GEN::user;

our $USER = 'Gantry::Samples::Model::user';
...
Gantry::Samples::Model::user - model for user table (stub part)
...
=head1 METHODS (mixed in from Gantry::Samples::Model::GEN::user)
