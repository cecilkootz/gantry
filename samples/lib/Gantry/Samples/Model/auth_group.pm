...
use Gantry::Samples::Model::GEN::auth_group;

our $AUTH_GROUP = 'Gantry::Samples::Model::auth_group';

our @EXPORT_OK = ( '$AUTH_GROUP' );

1;

=head1 NAME

Gantry::Samples::Model::auth_group - model for auth_group table (stub part)
...
=head1 METHODS (mixed in from Gantry::Samples::Model::GEN::auth_group)
